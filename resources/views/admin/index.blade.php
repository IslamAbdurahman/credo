    ...
    <div class="card">
        <div class="card-header">
            <ul class="navbar list-unstyled m-0 p-0">
                <li>
                    <h3 class="card-title">Adminlar</h3>
                </li>
                <li>
                    <!-- SEARCH FORM -->
                ...
                <tr>
                    ...
                    <td>
                        <div class="image">
                            ...
                            <img src="{{ asset('public/assets-turist/images/'.$admin->image) }}" class="img-circle elevation-2" height="30px" alt="User Image">
                            @endif
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        @if(Auth::user()->id != $admin->id && Auth::user()->role == 1)
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <img id="frame{{ $loop->index+1 }}" class="ml-2" src="{{asset('public/assets-turist/images/'.$admin->image)}}" width="100px" height="100px" alt="Image"/>
                                                        </div>
                                                    </div>
                            ...
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger{{ $admin->id }}">
