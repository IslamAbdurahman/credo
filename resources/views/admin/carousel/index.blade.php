    ...
    <div class="card">
        <div class="card-header">
            <ul class="navbar list-unstyled m-0 p-0">
                ...
                <li>
                    <!-- SEARCH FORM -->
                    <form action="{{ route('carousel.index') }}" method="get" class="form-inline m-0 ml-md-3">
                        @csrf
        ...
        <div class="card-body pt-0 table-responsive">
            <table id="example1" class="table table-bordered table-striped ">
                ...
                <tr>
                    ...
                    <th>
                        @if(Auth::user()->role == 1)
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#carousel_add">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
                                    <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                    <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                                </svg>
                            </button>
                            <div class="modal fade" id="carousel_add">
                ...
                @foreach($carousels as $carousel)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger{{ $carousel->id }}">
                                <i class="fas fa-trash m-0 p-0"></i>
                            </button>

                            <div class="modal fade" id="modal-danger{{ $carousel->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form class="d-inline" action="{{ route('carousel.destroy',$carousel->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
